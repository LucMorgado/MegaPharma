...
__webpack_require__(/*! ./funcoes.js */ "./resources/js/funcoes.js");
...
function estados() {
  var estado = document.getElementById('selEstados');
...
function cidades(estado) {
  var cidade = document.getElementById('selCidade');
...
function bairros(cidade) {
  var bairro = document.getElementById('selBairro');
...
function botao() {
  var bt = document.getElementById('selBt');
  bt.disabled = false;
}

function encontrar() {
  var xmlhttp = new XMLHttpRequest();
  var result = document.getElementById('selResult');
  var estado = document.getElementById('selEstados');
  var cidade = document.getElementById('selCidade');
  var bairro = document.getElementById('selBairro');
  var bt = document.getElementById('selBt');
